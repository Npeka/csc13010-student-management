...
document.getElementById("search").insertAdjacentHTML(
  "afterbegin",
  `
...
function exportToCSV() {
  ...
  const headers =
    "MSSV,Họ và tên,Ngày sinh,Giới tính,Khoa,Khóa,Chương trình,Địa chỉ,Email,Điện thoại,Trạng thái\n";
  const rows = studentManager.students
    .map(
      (student) =>
